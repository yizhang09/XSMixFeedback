...
public class EnhanceListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initRefreshStyle() {
        mHeaderReleaseMinDistance = getResources().getDimensionPixelSize(R.dimen.enhance_list_header_release_min_distance);
        ...
        mHeaderLayout = LayoutInflater.from(getContext()).inflate(R.layout.enhance_list_header, this, false);
        ...
        mHeaderProgressBar = (ProgressBar) mHeaderLayout.findViewById(R.id.enhance_list_header_progress_bar);
